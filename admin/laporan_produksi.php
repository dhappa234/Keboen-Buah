...
<div class="container">
	<h2 style=" width: 100%; border-bottom: 4px solid gray; padding-bottom: 5px;"><b>Laporan Produk</b></h2>
	<div class="row print">
		<div class="col-md-9">
	...
	<table class="table table-striped">
		...
		?>
		<tr>
			<td colspan="4" class="text-right"><b>Total Jumlah Produk = <?= $total; ?></b></td>
		</tr>
<?php 	} ?>
	</table>
</div>
