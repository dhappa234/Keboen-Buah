			...
			<form action="proses/add.php" method="GET">
				...
				<table class="table table-striped">
					<tbody>
						...
						<tr>
							<td><b>Jumlah</b></td>
							<td><input class="form-control" type="number" min="1" name="jml" value="1" style="width: 155px;" <?= ($stok > 0 ? '' : 'disabled'); ?>></td>
						</tr>
					</tbody>
				</table>
				<?php
				...
				?>
					<button type="submit" class="btn btn-success" <?= ($stok > 0 ? '' : 'disabled'); ?>><i class="glyphicon glyphicon-shopping-cart"></i> Tambahkan ke Keranjang</button>
				<?php
				} else {
