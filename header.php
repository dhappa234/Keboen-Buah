...
<body>
	<div class="container-fluid" style="background-color: #4ecdc4 !important;">
		<div class="row top text-center" style="background-color: transparent;">
			<div class="col-md-4" style="padding: 3px; color: white;">
				<span><i class="glyphicon glyphicon-earphone"></i> 0821-8972-7121</span>
			</div>
			<div class="col-md-4" style="padding: 3px; color: white;">
				<span><i class="glyphicon glyphicon-envelope"></i> Keboenbuah@gmail.com</span>
			</div>
			<div class="col-md-4" style="padding: 3px; color: white;">
				<span>Keboen Buah Semarang</span>
			</div>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #4ecdc4"><b>KEBOEN BUAH</b></a>
			</div>
